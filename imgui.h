...
enum ImDrawFlags_
{
    ...
    ImDrawFlags_ShadowCutOutShapeBackground = 1 << 9, // Do not render the shadow shape under the objects to be  to save on fill-rate or facilitate blending. Slower on CPU.
};
